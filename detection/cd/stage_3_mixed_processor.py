...
class MixedStageProcessor:
    ...
    def initialize_roi_tracker_if_needed(self, tracker_config: Dict[str, Any], 
        ...
        try:
                ...
                def __init__(self, det_model_path, pose_model_path, mixed_settings):
                    ...
                    class MockSettings:
                        def get(self, key, default=None):
                            ...
                            mixed_overrides = {
                                'oscillation_detector_grid_size': mixed_settings['grid_size'],
                                'oscillation_detector_sensitivity': tracker_config.get('oscillation_sensitivity', 1.5),  # Moderate sensitivity
                                'live_oscillation_dynamic_amp_enabled': True,
                                'yolo_oscillation_target_class': 'penis',
                                'yolo_oscillation_conf_threshold': 0.4
                            }
                            if key in mixed_overrides:
                                return mixed_overrides[key]
            ...
            # Initialize ROI tracker for oscillation detection only (no YOLO models)
