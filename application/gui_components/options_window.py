...
class OptionsWindow:
    ...
    # ============================================================
    # CONTENT RENDERING METHODS - Other Tabs (Stubs)
    # ============================================================

    def _render_display_content(self, horizontal_tab: str):
        """Render Display tab content."""
        imgui.text(f"Display > {horizontal_tab}")
        imgui.text("Coming soon...")
        imgui.spacing()
        imgui.text("This tab will contain:")
        if horizontal_tab == "Video":
            imgui.bullet_text("Video display settings")
            imgui.bullet_text("Stage 2 overlay options")
            imgui.bullet_text("Zoom defaults")
        elif horizontal_tab == "Gauges":
            imgui.bullet_text("Timeline 1/2 gauge windows")
            imgui.bullet_text("Movement bar / LR dial")
            imgui.bullet_text("3D simulator")
            imgui.bullet_text("Overlay modes")
        elif horizontal_tab == "Timelines":
            imgui.bullet_text("Interactive timelines")
            imgui.bullet_text("Heatmap settings")
            imgui.bullet_text("Chapter indicators")
        elif horizontal_tab == "Panels":
            imgui.bullet_text("Panel visibility")
            imgui.bullet_text("Floating window positions")

    def _render_ai_content(self, horizontal_tab: str):
        """Render AI Models tab content."""
        imgui.text(f"AI Models > {horizontal_tab}")
        imgui.text("Coming soon...")
    ...
    def _render_output_content(self, horizontal_tab: str):
        ...
        imgui.text(f"Output > {horizontal_tab}")
        imgui.text("Coming soon...")
