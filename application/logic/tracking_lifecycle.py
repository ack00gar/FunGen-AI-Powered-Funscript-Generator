...
class TrackingLifecycleController:
    ...
    def on_processing_stopped(self,
        ...
        if was_scripting_session:
            ...
            # Timeline cache reflects final live tracking data. Prevents
            # "points disappearing" after Ultimate Autotune is triggered
            # immediately post-generation.
            self._invalidate_all_timeline_caches()

            # Post-processing.
            any_processing_applied = self.run_post_analysis_pipeline(frame_range=scripted_frame_range)
